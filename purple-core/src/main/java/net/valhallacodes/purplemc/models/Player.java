...
package net.valhallacodes.purplemc.models;
...
public class Player {
    ...
    public String getFormattedName() {
        ...
        String prefix = tag.getColoredPrefix();
        String playerName = prefixType.getColor() + name;
    ...
    public void setRank(Rank rank) {
        this.rank = rank;
        this.tag = rank.getCorrespondingTag();
    }
